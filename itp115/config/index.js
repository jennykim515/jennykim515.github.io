...
if (assignment_key) {
    due_dates.innerHTML += assignment_key + " is due <strong>" + assignments[assignment_key].toDateString() + " at 11:59 P.M.</strong><br>";
} else {
...
if (lab_key) {
    due_dates.innerHTML += lab_key + " is due <strong>" + labs[lab_key].toDateString() + " at 11:59 P.M</strong>";
} else {
